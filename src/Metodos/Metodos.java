...
public class Metodos {
    ...
    public static ArrayList<MatImagem> TonsCinza(ArrayList<MatImagem> lista, int execucao, String destino, int etapa) throws IOException {
    ...
    public static ArrayList<MatImagem> Gaussian_Adp(ArrayList<MatImagem> lista, int execucao, String destino, int etapa) throws IOException {
        ArrayList<MatImagem> imagens = new ArrayList<MatImagem>();
    ...
    public static ArrayList<MatImagem> Otsu(ArrayList<MatImagem> lista, int execucao, String destino, int etapa) throws IOException {
        ArrayList<MatImagem> imagens = new ArrayList<MatImagem>();
    ...
    public ArrayList<MatImagem> identificarContornos(ArrayList<MatImagem> lista, int execucao, String destino, int etapa) throws IOException {

        ArrayList<MatImagem> imagens = new ArrayList<MatImagem>();
        //File a = new File(destino + "/Etapa" + etapa + "_Contorno"+thread);
        //a.mkdir();
        File b = new File(destino + "/Etapa" + etapa + "_Tickets");
        b.mkdir();
        for (MatImagem img : lista) {
            Mat imagem = img.getImg();
            ...
            for (Rect r : rects) {
                ...
                if (ContaPixel(aux) > 2000) {
                    ...
                    ImageIO.write(aux, "bmp", new File(destino + "\\Etapa" + etapa + "_Tickets\\" + arqOriginal + "_Figura" + index + ".bmp"));
    ...
    public ArrayList<MatImagem> Erosao(ArrayList<MatImagem> lista, int execucao, String destino, int etapa) throws IOException {
        ...
        for (MatImagem img : lista) {
            ...
            Imgproc.erode(imagem, Img_new, element);
            //ImageIO.write(mat2Img(Img_new), "bmp", new File(destino + "\\Etapa" + etapa + "_Erosao\\" + arqOriginal + "_Figura" + "_" + index + ".bmp"));
            MatImagem image = new MatImagem(Img_new, img.getNome());
            imagens.add(image);
            index++;
        }
    ...
    public void ReconhecerDigitos(int execucao, String destino, int etapa) throws IOException, TesseractException {
